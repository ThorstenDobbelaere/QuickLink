...
public class ResourceTests {
    ...
    public void getResource(){
        ...
        HttpResponse response = CallResolver.handleCallStatic("/resources/1");
    ...
    public void createIOResource(){
        ...
        HttpResponse response = CallResolver.handleCallStatic("/resources/create-io/Sugar/sugar/10.0");
    ...
    public void createInputResource(){
        ...
        HttpResponse response = CallResolver.handleCallStatic("/resources/create-input/Coal/coal/5.5");
    ...
    public void getResources(){
        ...
        HttpResponse response = CallResolver.handleCallStatic("/resources/all");
    ...
    public void deleteResourceByName(){
        ...
        CallResolver.handleCallStatic("/resources/delete/iron_ore");
    ...
    private void assertResourceExists(String referenceName){
        HttpResponse response = CallResolver.handleCallStatic("/resources/name/" + referenceName);
        Assertions.assertSame(HttpStatus.OK, response.getStatus());
        Assertions.assertSame(ContentType.PLAIN, response.getContentType());
