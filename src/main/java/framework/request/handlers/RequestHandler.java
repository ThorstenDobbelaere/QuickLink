...
import framework.request.handlers.impl.*;
...
public abstract class RequestHandler{
    ...
    private static RequestHandler createIORequestHandler(MethodInfo methodInfo, IOMapping ioMapping) {
        ...
        if(returnType.equals(ResponseEntity.class)) {
            ...
            return new CustomIORequestHandler(url, stringifier, responseEntitySupplier, requiredTypes, paramNames);
        }
        ...
        return new IORequestHandler(url, stringifier, handler, requiredTypes, paramNames);
    }
