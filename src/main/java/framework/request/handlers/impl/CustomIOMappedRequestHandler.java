...
public class CustomIOMappedRequestHandler extends MappedRequestHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CustomIOMappedRequestHandler.class);
    ...
    public CustomIOMappedRequestHandler(String mapping, OutputConverter outputConverter, Function<Object[], ResponseEntity> callback, List<Class<?>> expectedClasses, List<String> paramNames) {
        super(mapping);
